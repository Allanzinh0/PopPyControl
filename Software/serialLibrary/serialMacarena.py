...
time.sleep(bufferTime)
goToPosition(torso, 52, 950)
time.sleep(bufferTime)
goToPosition(torso, 53, 895)
time.sleep(bufferTime)
goToPosition(torso, 54, 2834)
time.sleep(executionTime)
...
time.sleep(executionTime/4)
goToPosition(torso, 53, 1867)
time.sleep(bufferTime)
goToPosition(torso, 51, 717)
time.sleep(executionTime)

# Posicao 12
print('\nAtivando posicao 12!')
goToPosition(torso, 31, 1965)
time.sleep(bufferTime)
goToPosition(torso, 41, 2884)
time.sleep(executionTime/4)
goToPosition(torso, 41, 3280)
time.sleep(bufferTime)
goToPosition(torso, 42, 3136)
time.sleep(bufferTime)
goToPosition(torso, 43, 2075)
time.sleep(bufferTime)
goToPosition(torso, 44, 1439)
time.sleep(executionTime)
