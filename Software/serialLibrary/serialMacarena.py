...
time.sleep(startTime)
goToPosition(torso, 31, 1993)
time.sleep(startTime)
goToPosition(torso, 32, 2093)
time.sleep(startTime)
goToPosition(torso, 33, 2046)
time.sleep(startTime)
goToPosition(torso, 34, 2147)
time.sleep(startTime)
...
time.sleep(bufferTime)
goToPosition(torso, 43, 1928)
time.sleep(bufferTime)
goToPosition(torso, 44, 2570)
time.sleep(executionTime)

# Posicao 09
print('\nAtivando posicao 9!')
goToPosition(torso, 31, 2020)
time.sleep(bufferTime)
goToPosition(torso, 51, 1246)
time.sleep(bufferTime)
goToPosition(torso, 52, 1030)
time.sleep(executionTime/4)
goToPosition(torso, 54, 2675)
time.sleep(executionTime/4)
goToPosition(torso, 53, 970)
time.sleep(executionTime)

# Posicao 10
print('\nAtivando posicao 10!')
goToPosition(torso, 41, 2777)
time.sleep(bufferTime)
goToPosition(torso, 42, 3252)
time.sleep(bufferTime)
goToPosition(torso, 44, 1724)
time.sleep(executionTime/4)
goToPosition(torso, 43, 2738)
time.sleep(executionTime)

# Posicao 11
print('\nAtivando posicao 11!')
goToPosition(torso, 52, 1287)
time.sleep(bufferTime)
goToPosition(torso, 54, 2595)
time.sleep(bufferTime)
goToPosition(torso, 51, 1133)
time.sleep(executionTime/4)
goToPosition(torso, 53, 1014)
time.sleep(bufferTime)
goToPosition(torso, 51, 1008)
time.sleep(bufferTime)
goToPosition(torso, 52, 1522)
time.sleep(bufferTime)
goToPosition(torso, 54, 3217)
time.sleep(executionTime)

# Posicao 12
print('\nAtivando posicao 12!')
goToPosition(torso, 41, 3117)
time.sleep(executionTime/4)
goToPosition(torso, 42, 2672)
time.sleep(bufferTime)
goToPosition(torso, 43, 2773)
time.sleep(bufferTime)
goToPosition(torso, 44, 2262)
time.sleep(executionTime)
